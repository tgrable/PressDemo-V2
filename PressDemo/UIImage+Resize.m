              ...
              atPoint:(CGPoint)  point
{
    ...
    [fgImage drawInRect:CGRectMake( point.x, point.y, bgImage.size.width, bgImage.size.height)];
...
{
    //get size
    CGSize border = CGSizeMake(fabs(offset.width) + blur, fabsf(offset.height) + blur);
