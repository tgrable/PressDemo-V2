...
@interface AppDataObject : NSObject{
    ...
    NSMutableArray *initialSofwareData, *initialFilesToDownload, *initialBannerData, *searchableMillData, *searchablePaperDataObjects, *searchDataArray;
}
...
@property (nonatomic, strong)NSMutableArray *initialBannerData, *initialPartnerData, *initialSofwareData, *initialFilesToDownload, *searchableMillData, *searchablePaperDataObjects, *searchDataArray;
